...
let respostas0 =  ["Ri dele", "Tenta  ajudar", "Você entra em desespero", "conserta a cadeira e ajuda"]
...
let respostas3 = ["Sim, muito quando me aborrecem", "Sim, mas de modo inteligente", "Com um bom motivo, sim", "Não sinto, prefiro perdoar"]
...
let respostas6 = ["As vezes", "Apenas quando preciso", "sim, existem situações que é preciso", "Evito, mas acabo mentindo"]
let respostas7 = ["Muito abalado", "De certo modo abalado", "Com o tempo bem", "museu que vive de passado"]
let respostas8 = ["Terrivelmente triste", "Triste e em pouco tempo bem", "Um pouco triste de momento", "surpreso e incrédulo"]
