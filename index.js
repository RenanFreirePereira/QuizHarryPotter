...
let questoes = ["Complete: seu amigo foi atacado pelo dementador, então você...", "O que você mais escuta frequentemente?", "Você fácilmente amaria alguém?", "você sente vontade de se vingar de algo?", "Qual seria a sua abordagem ao enfrentar um desafio difícil?", "Como você prefere passar seu tempo livre?", "você mente muito facilmente?", "Se você terminasse um namoro com alguém, qual seria sua reação?", "Se o seu melhor amigo se afastasse de você, como você ficaria?"] 
...
let respostas5 = ["Lendo e estudando", "Explorando ideias", "Com meus amigos", "Sozinho no celular"]
